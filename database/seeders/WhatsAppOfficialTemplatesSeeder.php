...
class WhatsAppOfficialTemplatesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                'key' => 'trial.ends_in_7_days',
                'meta_template_name' => 'saas_trial_ends_in_7_days',
                'category' => 'UTILITY',
                'body_text' => "Ola {{1}}.\n\nSeu periodo de teste termina em 7 dias para {{2}}.\nPlano: {{3}}.\nFim do trial: {{4}}.\nAcesse para continuar: {{5}}.",
                'variables' => [
                    '1' => 'customer_name',
                    '2' => 'tenant_name',
                    '3' => 'plan_name',
                ...
                'sample_variables' => [
                    ...
                    '3' => 'Plano Premium',
                    '4' => '25/03/2026',
                    '5' => 'https://app.allsync.com.br/workspace/clinica/subscription',
                ],
            ],
            [
                'key' => 'trial.ends_in_3_days',
                'meta_template_name' => 'saas_trial_ends_in_3_days',
                'category' => 'UTILITY',
                'body_text' => "Ola {{1}}.\n\nSeu periodo de teste termina em 3 dias para {{2}}.\nPlano: {{3}}.\nFim do trial: {{4}}.\nEvite interrupcoes: {{5}}.",
                'variables' => [
                    '1' => 'customer_name',
                    '2' => 'tenant_name',
                    '3' => 'plan_name',
            ...
            [
                'key' => 'trial.ends_today',
                'meta_template_name' => 'saas_trial_ends_today',
                'category' => 'UTILITY',
                'body_text' => "Ola {{1}}.\n\nSeu periodo de teste termina hoje para {{2}}.\nPlano: {{3}}.\nFim do trial: {{4}}.\nContinue com um plano: {{5}}.",
                'variables' => [
                    '1' => 'customer_name',
                    '2' => 'tenant_name',
                    '3' => 'plan_name',
            ...
            [
                'key' => 'trial.expired',
                'meta_template_name' => 'saas_trial_expired',
                'category' => 'UTILITY',
                'body_text' => "Ola {{1}}.\n\nO periodo de teste de {{2}} expirou.\nPlano testado: {{3}}.\nFim do trial: {{4}}.\nReative sua conta: {{5}}.",
                'variables' => [
                    '1' => 'customer_name',
                    '2' => 'tenant_name',
                    '3' => 'plan_name',
