<div class="actions-wrap">
    <a
        href="{{ workspace_route('tenant.business-hours.show', $hour->id) }}"
        title="Ver"
    ...
    <form
        id="business-hours-delete-form-{{ $hour->id }}"
        action="{{ workspace_route('tenant.business-hours.destroy', $hour->id) }}"
        method="POST"
        class="inline-flex"
    ...
    >
        ...
        <button
            ...
            data-delete-form="#business-hours-delete-form-{{ $hour->id }}"
