...
@section('title', 'Editar Template de Campanha')
@section('page', 'campaign-templates')

@section('content')
    @php
        $formAction = workspace_route('tenant.campaign-templates.update', ['campaignTemplate' => $campaignTemplate->id]);
        $httpMethod = 'PUT';
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Template de Campanha</h1>
