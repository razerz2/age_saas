<div class="actions-wrap">
    <a
        href="{{ workspace_route('tenant.appointment-types.show', $type->id) }}"
        title="Ver"
    ...
    <form
        id="appointment-types-delete-form-{{ $type->id }}"
        action="{{ workspace_route('tenant.appointment-types.destroy', $type->id) }}"
        method="POST"
        class="inline-flex"
    ...
    >
        ...
        <button
            ...
            data-delete-form="#appointment-types-delete-form-{{ $type->id }}"
