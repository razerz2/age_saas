...
<div class="actions-wrap">
    ...
    <form id="forms-delete-form-{{ $form->id }}" action="{{ workspace_route('tenant.forms.destroy', ['form' => $form->id]) }}" method="POST" class="inline-flex"
        ...
        <button
            ...
            data-delete-form="#forms-delete-form-{{ $form->id }}"
            data-delete-title="Excluir formulário"
            data-delete-message="Tem certeza que deseja excluir o formulário {{ $form->name }}?"
