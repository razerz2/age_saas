...
@section('title', 'Execuções da Campanha')
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                <x-icon name="chevron-right" size="text-sm" class="text-gray-400" />
                                <span class="ml-1 text-gray-500 dark:text-gray-400">Execuções</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="mt-3 text-2xl font-bold text-gray-900 dark:text-white">Execuções da campanha</h1>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ workspace_route('tenant.campaigns.recipients.index', ['campaign' => $campaign->id]) }}" class="btn btn-outline inline-flex items-center">
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Histórico de execuções</h2>
            </div>
            <div class="p-6">
                <div
                    id="campaign-runs-grid-wrapper"
                    data-grid-url="{{ workspace_route('tenant.campaigns.runs.grid', ['campaign' => $campaign->id]) }}"
                >
                    <div id="campaign-runs-grid"></div>
                </div>
            </div>
        </div>
    </div>
