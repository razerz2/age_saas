...
@section('title', 'Relatorio de Notificacoes')
@section('page', 'reports')

@section('content')
<div
    id="reports-notifications-config"
    data-report-type="notifications"
    data-grid-url="{{ workspace_route('tenant.reports.notifications.grid-data') }}"
    data-export-excel-url="{{ workspace_route('tenant.reports.notifications.export.xlsx') }}"
    data-export-pdf-url="{{ workspace_route('tenant.reports.notifications.export.pdf') }}"
></div>

<div class="page-header mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Relatorio de Notificacoes</h1>
</div>
