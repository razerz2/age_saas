...
@section('content')
<div
    id="reports-doctors-config"
    data-report-type="doctors"
    data-grid-url="{{ workspace_route('tenant.reports.doctors.grid-data') }}"
    data-export-excel-url="{{ workspace_route('tenant.reports.doctors.export.xlsx') }}"
    data-export-pdf-url="{{ workspace_route('tenant.reports.doctors.export.pdf') }}"
></div>
