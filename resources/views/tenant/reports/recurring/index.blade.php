...
<div id="reports-recurring-config" data-report-type="recurring" data-data-url="{{ workspace_route('tenant.reports.recurring.data') }}"></div>

<div class="page-header mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Relatório de Recorrências</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Relatórios de recorrências</p>
    </div>
    <nav class="mt-4" aria-label="breadcrumb">
        <ol class="flex items-center flex-wrap gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li class="flex items-center gap-2">
                ...
                <span class="text-gray-700 dark:text-gray-200">Recorrências</span>
            </li>
        </ol>
    </nav>
</div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm" id="reports-table">
            <thead class="bg-gray-50 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Data de Criação</th>
