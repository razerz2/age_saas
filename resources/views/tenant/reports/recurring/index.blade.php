...
@section('title', 'Relatorio de Recorrencias')
@section('page', 'reports')

@section('content')
<div
    id="reports-recurring-config"
    data-report-type="recurring"
    data-grid-url="{{ workspace_route('tenant.reports.recurring.grid-data') }}"
    data-export-excel-url="{{ workspace_route('tenant.reports.recurring.export.xlsx') }}"
    data-export-pdf-url="{{ workspace_route('tenant.reports.recurring.export.pdf') }}"
></div>

<div class="page-header mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Relatorio de Recorrencias</h1>
</div>
