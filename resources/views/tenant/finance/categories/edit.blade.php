...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
            <i class="mdi mdi-tag-edit text-primary me-2"></i>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ workspace_route('tenant.finance.categories.update', ['slug' => tenant()->subdomain, 'category' => $category->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
