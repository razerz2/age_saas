                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <form action="{{ workspace_route('tenant.finance.accounts.destroy', ['slug' => tenant()->subdomain, 'account' => $account->id]) }}"
                                          ...
                                          onsubmit="event.preventDefault(); confirmAction({ title: 'Excluir conta', message: 'Tem certeza que deseja excluir esta conta?', confirmText: 'Excluir', cancelText: 'Cancelar', type: 'error', onConfirm: () => event.target.submit() }); return false;">
                                        @csrf
                                        @method('DELETE')
