...
@section('content')
    ...
    <div class="page-header mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Contas Financeiras</h1>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-500 dark:text-gray-400 md:ml-2">Contas</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div>
                <a href="{{ workspace_route('tenant.finance.accounts.create') }}" class="btn-patient-primary">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-6">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Lista de Contas</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Saldo Inicial</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Saldo Atual</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($accounts as $account)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">R$ {{ number_format($account->initial_balance, 2, ',', '.') }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">R$ {{ number_format($account->current_balance, 2, ',', '.') }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    @if($account->active)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <form id="finance-accounts-delete-form-{{ $account->id }}"
                                          action="{{ workspace_route('tenant.finance.accounts.destroy', ['slug' => tenant()->subdomain, 'account' => $account->id]) }}"
                                        ...
                                        <button type="button"
                                                ...
                                                data-delete-form="#finance-accounts-delete-form-{{ $account->id }}"
                                                data-delete-title="Excluir conta"
                                                data-delete-message="Tem certeza que deseja excluir esta conta?">
                                            Excluir
                                        </button>
                                    </form>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">Nenhuma conta cadastrada.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
