...
@section('content')
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <h3 class="page-title mb-0"> Editar Calendário </h3>
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ workspace_route('tenant.calendars.update', $calendar->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            <a href="{{ workspace_route('tenant.calendars.index') }}" class="btn btn-light">
