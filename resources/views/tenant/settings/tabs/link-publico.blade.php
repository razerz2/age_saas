            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" 
                               readonly
                               value="{{ route('public.appointment.create', ['slug' => tenant()->subdomain]) }}" 
                        ...
                        <button type="button" 
                                onclick="navigator.clipboard.writeText('{{ route('public.appointment.create', ['slug' => tenant()->subdomain]) }}')"
                    ...
                    <div class="space-y-3">
                        @if(!empty($settings['public_booking.logo']))
                            <div class="flex items-center gap-4 p-3 border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700">
                                ...
                                <button type="button" 
                                        onclick="document.getElementById('remove_logo').value = '1'; this.closest('form').submit()"
