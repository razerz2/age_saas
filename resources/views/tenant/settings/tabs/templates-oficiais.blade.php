<div class="space-y-6">
    <div class="mb-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
            Gerencie os templates oficiais da Meta para os eventos clinicos padrao do tenant.
        </p>
    </div>
    ...
    <div class="rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-900/50 dark:bg-blue-900/20 dark:text-blue-200">
        Esta aba fica disponivel somente quando o tenant usa API propria oficial da Meta
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h3 class="text-base font-semibold text-gray-900 dark:text-white">Gestao de Templates Oficiais</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Criacao, edicao, submissao para Meta, sincronizacao e teste manual.
                </p>
            </div>
