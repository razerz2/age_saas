...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col gap-2">
            ...
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Google Calendar por Medico</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">A conexao e individual por medico; as credenciais OAuth sao globais (Platform com fallback para ambiente). A autenticacao deve ser iniciada na Agenda do Profissional.</p>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="p-6 space-y-3 text-sm text-gray-600 dark:text-gray-300">
                ...
                <p>- Com credenciais ativas, cada medico pode conectar/desconectar sua conta Google.</p>
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        @if ($doctor->googleCalendarToken)
                                            ...
                                            @if ($doctor->googleCalendarToken->isExpired())
                                                <div class="mt-1 text-xs text-yellow-700 dark:text-yellow-300">Token expirado (renovacao automatica quando possivel)</div>
                                            @endif
                                        @else
