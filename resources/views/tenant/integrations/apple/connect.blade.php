    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-2">
            <nav aria-label="breadcrumb">
                <ol class="flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <li>/</li>
                    <li><a href="{{ workspace_route('tenant.integrations.apple.index') }}" class="hover:text-gray-800 dark:hover:text-white">Apple Calendar</a></li>
                    <li>/</li>
                    <li class="font-medium text-gray-900 dark:text-white">Conectar</li>
                </ol>
            </nav>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Conectar Apple Calendar</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">Medico: {{ $doctor->user->name_full ?? $doctor->user->name }}</p>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Orientacoes</h2>
            </div>
            <div class="p-6 text-sm text-gray-600 dark:text-gray-300">
                <ol class="list-decimal space-y-2 pl-5">
                    ...
                    <li>Gere uma senha de app na secao de seguranca.</li>
                    <li>Use o email iCloud e a senha de app no formulario abaixo.</li>
                    <li>Se nao informar <code>calendar_url</code>, o sistema tenta descobrir automaticamente.</li>
                </ol>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <form action="{{ workspace_route('tenant.integrations.apple.connect', ['doctor' => $doctor->id]) }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="server_url" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Server URL</label>
                    ...
                    <div>
                        <label for="calendar_url" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Calendar URL (opcional)</label>
                ...
                <div class="flex flex-wrap items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-700">
                    <a href="{{ workspace_route('tenant.integrations.apple.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700/60">Cancelar</a>
