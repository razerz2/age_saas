<div class="actions-wrap">
    ...
    <a
        ...
        dusk="patients-edit-action-{{ $patient->id }}"
        title="Editar"
        onclick="event.stopPropagation()"
    ...
    <form
        id="patients-delete-form-{{ $patient->id }}"
        action="{{ workspace_route('tenant.patients.destroy', $patient->id) }}"
        method="POST"
        class="inline-flex delete-patient-form"
    ...
    >
        ...
        <button
            type="button"
            dusk="patients-delete-action-{{ $patient->id }}"
            title="Excluir"
