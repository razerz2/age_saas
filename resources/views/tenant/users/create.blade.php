...
@php
    ...
    $oldDoctorPrimarySpecialty = old('doctor.primary_specialty_id');
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <form method="POST" action="{{ workspace_route('tenant.users.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="role" id="role-select" 
                                ...
                                <option value="doctor" {{ old('role') == 'doctor' ? 'selected' : '' }}>Usuário {{ $professionalSingular }}</option>
                ...
                <!-- Seção: Permissões de Profissionais (para usuário comum) -->
                <div class="mb-8 hidden" id="doctor-permissions-section">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4 flex items-center">
                        <x-icon name="stethoscope" size="text-lg" class="mr-2 text-blue-600 dark:text-blue-400" />
                        {{ $professionalPlural }} Permitidos
                    </h3>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Selecione os {{ $professionalPluralLower }} que este usuário pode visualizar:</label>
                        @php
