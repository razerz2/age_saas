            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen" class="shadow-theme-lg dark:bg-gray-900 absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                    ...
                    <ul class="mt-4 flex flex-col gap-1 border-t border-gray-200 pt-3 dark:border-gray-800">
                        <li>
                            <a href="{{ workspace_route('tenant.profile.edit') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5">
                        ...
                        @endif
                        <li>
                            <a href="{{ route('tenant.logout', ['slug' => $headerTenantSlug]) }}" 
...
<!-- Logout Form -->
<form id="logout-form" action="{{ route('tenant.logout', ['slug' => $headerTenantSlug]) }}" method="POST" class="d-none">
    @csrf
</form>
