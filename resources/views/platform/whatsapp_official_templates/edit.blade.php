...
@section('title', 'Editar Template WhatsApp Oficial')

@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Editar Template WhatsApp Oficial</h4>
    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Platform.whatsapp-official-templates.update', $template) }}">
                    @csrf
                    @method('PUT')
