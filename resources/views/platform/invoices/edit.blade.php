            ...
            <form method="POST" action="{{ route('Platform.invoices.update', $invoice->id) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tenant_id" class="form-control" required>
                            @foreach ($tenants as $tenant)
                                <option value="{{ $tenant->id }}" {{ $invoice->tenant_id == $tenant->id ? 'selected' : '' }}>
                                    {{ $tenant->trade_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="subscription_id" class="form-control" required>
                            @foreach ($subscriptions as $sub)
                                <option value="{{ $sub->id }}" {{ $invoice->subscription_id == $sub->id ? 'selected' : '' }}>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="amount_cents" id="amount_cents" value="{{ $invoice->amount_cents }}">
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="url" name="payment_link" class="form-control" value="{{ $invoice->payment_link }}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="provider_id" class="form-control" value="{{ $invoice->provider_id }}">
                    </div>
                </div>
