                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="period_months" class="form-select" required>
                                @for ($i = 1; $i <= 12; $i++)
                                    <option value="{{ $i }}"
                                        {{ old('period_months', $plan->period_months) == $i ? 'selected' : '' }}>
                                        {{ $i }} {{ $i == 1 ? 'mês' : 'meses' }}
                                    </option>
                                @endfor
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" rows="2" 
                                placeholder="Breve descrição do plano que será exibida antes dos recursos na landing page (máximo 500 caracteres)">{{ old('description', $plan->description) }}</textarea>
