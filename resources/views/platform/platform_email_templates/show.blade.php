...
@section('title', 'Detalhes Template de Email Platform')

@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Detalhes Template de Email Platform</h4>
            ...
            <div class="col-5 align-self-center text-end">
                <div class="d-flex justify-content-end gap-2">
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#platformEmailTestSendModal">
                        <i class="fas fa-vial me-1"></i> Testar envio
                    </button>
                    <a href="{{ route('Platform.platform-email-templates.edit', $template) }}" class="btn btn-warning text-white">
                        <i class="fas fa-edit me-1"></i> Editar
                    </a>
                    <a href="{{ route('Platform.platform-email-templates.index') }}" class="btn btn-outline-secondary">Voltar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            Escopo atual: Platform. O teste envia somente assunto e body do template atual, sem uso de módulo WhatsApp e sem layout estrutural.
        </div>
    ...
    @include('platform.email_templates._test_send_modal', [
        'template' => $template,
        'modalId' => 'platformEmailTestSendModal',
        'routeName' => 'Platform.platform-email-templates.test-send',
    ])
