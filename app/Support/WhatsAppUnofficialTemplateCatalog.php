    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Trial termina em 7 dias',
                'category' => 'subscription',
                'body' => "Ola {{customer_name}}!\n\nSeu periodo de teste termina em 7 dias para {{tenant_name}}.\nPlano: {{plan_name}}\nFim do trial: {{trial_ends_at}}\nEscolha um plano: {{upgrade_url}}",
                'variables' => [
                    'customer_name',
                    'tenant_name',
                    'plan_name',
            ...
            [
                ...
                'category' => 'subscription',
                'body' => "Ola {{customer_name}}!\n\nSeu periodo de teste termina em 3 dias para {{tenant_name}}.\nPlano: {{plan_name}}\nFim do trial: {{trial_ends_at}}\nEvite interrupcoes: {{upgrade_url}}",
                'variables' => [
                    'customer_name',
                    'tenant_name',
                    'plan_name',
            ...
            [
                ...
                'title' => 'Trial termina hoje',
                'category' => 'subscription',
                'body' => "Ola {{customer_name}}!\n\nSeu periodo de teste termina hoje para {{tenant_name}}.\nPlano: {{plan_name}}\nFim do trial: {{trial_ends_at}}\nContinue com um plano: {{upgrade_url}}",
                'variables' => [
                    'customer_name',
                    'tenant_name',
                    'plan_name',
            ...
            [
                ...
                'category' => 'subscription',
                'body' => "Ola {{customer_name}}!\n\nO periodo de teste de {{tenant_name}} expirou.\nPlano testado: {{plan_name}}\nFim do trial: {{trial_ends_at}}\nReative sua conta: {{upgrade_url}}",
                'variables' => [
                    'customer_name',
                    'tenant_name',
                    'plan_name',
