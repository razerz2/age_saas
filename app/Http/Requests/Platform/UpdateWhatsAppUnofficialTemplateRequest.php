...
class UpdateWhatsAppUnofficialTemplateRequest extends FormRequest
{
    ...
    {
        $templateId = (string) optional($this->route('whatsappUnofficialTemplate'))->id;
        ...
        return [
            'key' => [
                ...
                Rule::unique('whatsapp_unofficial_templates', 'key')->ignore($templateId),
            ],
