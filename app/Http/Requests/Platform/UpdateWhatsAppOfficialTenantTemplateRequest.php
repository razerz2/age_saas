...
class UpdateWhatsAppOfficialTenantTemplateRequest extends FormRequest
{
    ...
    {
        $mappingId = (string) optional($this->route('whatsappOfficialTenantTemplate'))->id;
        ...
        return [
            ...
            'event_key' => [
                ...
                Rule::unique('tenant_whatsapp_official_templates', 'event_key')
                    ->ignore($mappingId)
